...
from ultralytics.utils.metrics import OKS_SIGMA, TRI_WEIGHT
...
class v8PoseLoss(v8DetectionLoss):
    ...
    def __init__(self, model):  # model must be de-paralleled
        ...
        self.triangle_loss = TriangleLoss(tri_weight=TRI_WEIGHT)
    ...
    def calculate_keypoints_loss(self, masks, target_gt_idx, keypoints, batch_idx, stride_tensor, target_bboxes,
        ...
        if masks.any():
            ...
            tri_loss = self.triangle_loss(pred_kpt, gt_kpt)

        return kpts_loss, kpts_obj_loss, tri_loss
